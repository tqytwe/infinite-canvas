...
export function PromptSelectDialog({ open, onOpenChange, onSelect, mediaType = "all" }: { open: boolean; onOpenChange: (open: boolean) => void; onSelect: (prompt: string) => void; mediaType?: PromptMediaType }) {
