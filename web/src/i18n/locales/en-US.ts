export default {
    meta: {
        title: "Jisudeng",
        description: "Jisudeng AI Creation Space",
    },
    ...
    prompts: {
        ...
        total: "{{count}} prompts",
        allMedia: "All",
        imageMedia: "Image prompts",
        videoMedia: "Video prompts",
        canvasMedia: "Canvas templates",
        category: "Category",
        tags: "Tags",
    ...
    imageWorkbench: {
        ...
        deliveryPending: "The image is generated; saving it to the creation space",
        deliveryRecovered: "The image was saved to the creation space",
        retryDelivery: "Retry save",
    ...
    videoWorkbench: {
        ...
        deliveryPending: "The video is generated; saving it to the creation space",
        deliveryRecovered: "The video was saved to the creation space",
        retryDelivery: "Retry save",
    ...
    canvas: {
        ...
        export: { defaultProjectName: "Jisudeng", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
    ...
    topNav: {
        ...
        docs: "Documentation",
        returnPlatform: "Back to Jisudeng",
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>Jisudeng AI Creation Space</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by Jisudeng, grouped by object store.",
        ...
        promptSources: {
            ...
            localBundle: "Local data bundled with this release",
            scheduleDescription: "Built-in prompts ship with the release and load on demand. Scheduled fetching only applies to remote sources added by an administrator.",
            intervals: {
                disabled: "Disabled",
            ...
            runtime: { requestFailed: "Request failed ({{status}})", urlRequired: "JSON URL is required", fetchFailed: "Failed to fetch “{{name}}”: {{error}}", noPrompts: "No valid prompts were parsed from “{{name}}”", invalidRoot: "Invalid “{{name}}” format: the root value must be an array", invalidMarkdown: "Invalid “{{name}}” format: the source must be Markdown text" },
        },
