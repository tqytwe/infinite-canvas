export default {
    ...
    imageWorkbench: {
        ...
        deliveryPending: "生成已完成，结果正在保存到创作空间",
        deliveryRecovered: "结果已保存到创作空间",
        retryDelivery: "重试保存",
        empty: "还没有生成图片",
    ...
    videoWorkbench: {
        ...
        busy: "视频工作台已有任务正在运行",
        generated: "视频已生成",
        deliveryPending: "视频已生成，结果正在保存到创作空间",
        deliveryRecovered: "视频结果已保存到创作空间",
        retryDelivery: "重试保存",
    ...
    config: {
        ...
        promptSources: {
            ...
            localBundle: "随版本发布的本地数据包",
            scheduleDescription: "内置提示词随版本发布并按需懒加载；定时拉取只作用于管理员添加的远程来源。",
            intervals: {
                disabled: "关闭定时",
                minutes30: "每 30 分钟",
                hour1: "每 1 小时",
            ...
            runtime: { requestFailed: "请求失败（{{status}}）", urlRequired: "JSON URL 不能为空", fetchFailed: "「{{name}}」拉取失败：{{error}}", noPrompts: "「{{name}}」未解析到有效提示词", invalidRoot: "「{{name}}」格式错误：根节点必须是数组", invalidMarkdown: "「{{name}}」格式错误：内容必须是 Markdown 文本" },
        },
